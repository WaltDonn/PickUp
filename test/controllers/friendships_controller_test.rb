...
class FriendshipsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create friendship" do
    assert_difference('Friendship.count') do
      post friendships_url, params: { friendship: { friend1ID: @friendship.friend1ID, friend2ID: @friendship.friend2ID } }
    end
  ...
  test "should update friendship" do
    patch friendship_url(@friendship), params: { friendship: { friend1ID: @friendship.friend1ID, friend2ID: @friendship.friend2ID } }
